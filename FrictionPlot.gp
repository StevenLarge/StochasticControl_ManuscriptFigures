...
set label 3 "A^*" at screen 0.7875,0.92 center font "Times-New-Roman, 14"
set label 4 "0" at screen 0.775,0.85 center font "Times-New-Roman, 12"
set label 5 "0.5" at screen 0.775,0.80 center font "Times-New-Roman, 12"
set label 6 "1" at screen 0.775,0.75 center font "Times-New-Roman, 12"
set label 7 "2" at screen 0.775,0.70 center font "Times-New-Roman, 12"
set label 8 "4" at screen 0.775,0.65 center font "Times-New-Roman, 12"

set arrow from screen 0.80,0.85 to screen 0.825,0.85 nohead lw 2 lc rgb "#d0d1e6"
set arrow from screen 0.80,0.80 to screen 0.825,0.80 nohead lw 2 lc rgb "#a6bddb"
set arrow from screen 0.80,0.75 to screen 0.825,0.75 nohead lw 2 lc rgb "#74a9cf"
set arrow from screen 0.80,0.70 to screen 0.825,0.70 nohead lw 2 lc rgb "#2b8cbe"
set arrow from screen 0.80,0.65 to screen 0.825,0.65 nohead lw 2 lc rgb "#045a8d"
...
plot "FrictionData/FrictionMod_A4.dat" using 1:2 with line lt 1 lw 3.5 lc rgb "#045a8d", \
	"FrictionData/FrictionMod_A2.dat" using 1:2 with line lt 1 lw 3.5 lc rgb "#2b8cbe", \
	"FrictionData/FrictionMod_A1.dat" using 1:2 with line lt 1 lw 3.5 lc rgb "#74a9cf", \
	"FrictionData/FrictionMod_A05.dat" using 1:2 with line lt 1 lw 3.5 lc rgb "#a6bddb", \
	"FrictionData/FrictionMod_A0.dat" using 1:2 with line lt 1 lw 3.5 lc rgb "#d0d1e6"
